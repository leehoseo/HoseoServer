...
set_target_properties(SOCI::soci_core PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/soci_core_4_0.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/soci_core_4_0.dll"
  )
...
set_target_properties(SOCI::soci_core_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libsoci_core_4_0.lib"
  )
...
set_target_properties(SOCI::soci_empty PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/soci_empty_4_0.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "SOCI::soci_core"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/soci_empty_4_0.dll"
  )
...
set_target_properties(SOCI::soci_empty_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libsoci_empty_4_0.lib"
  )
...
set_target_properties(SOCI::soci_odbc PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/soci_odbc_4_0.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "SOCI::soci_core;odbc32.lib;odbc32.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/soci_odbc_4_0.dll"
  )
...
set_target_properties(SOCI::soci_odbc_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "odbc32.lib;odbc32.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libsoci_odbc_4_0.lib"
  )
